<template>
  <div>
    <h3>1. Ajouter des composants réutilisables</h3>
    ...
    <h3>2. Supprimer des composants réutilisables</h3>
    Pour supprimer des composants réutilisables, il suffit de supprimer le
    fichier dans le dossier components.
    <br />

    <h3>3. Publier des composants</h3>

    <h5>Étape 1 - Configuration de la construction de la bibliothèque</h5>
    ...
    <br />
    <h5>Étape 3 - Ajouter l'attribut files à votre package.json</h5>
    ...
    <h5>Etape 4- Ajout/Connexion sur npm en tant qu'utilisateur</h5>
    ...
    <br />
    <h5>Étape 6 - Nommer votre bibliothèque de composants</h5>
    ...
    <br />
    <h5>Étape 7 - Construction</h5>
    Construisez votre paquet en exécutant le script de paquet que vous avez
    ajouté à l'étape 1.
    <br />
    <h5>Étape 8 - Publication de votre bibliothèque de composants sur npm</h5>
